...
function drawDreTable(
  ...
  const rows: Row[] = [
    ...
    { kind: "item", label: "(–) Custo das Mercadorias Vendidas", rx: [/^\(?-?\)?\s*custo\s+das?\s+mercadorias/i, /^cmv$/i] },
    { kind: "item", label: "Despesas Operacionais", rx: [/^despesas?\s+operacionais$/i, /^despesas?\s+fixas$/i] },
    { kind: "item", label: "Despesas com Prestadores de Serviços", rx: [/^despesas?\s+com\s+prestadores?\s+de\s+servi[çc]os$/i, /^prestadores?\s+de\s+servi[çc]os$/i] },
    ...
    { kind: "item", label: "Despesas de Utilidades", rx: [/^despesas?\s+de\s+utilidades$/i, /^utilidades$/i] },
    { kind: "item", label: "Despesas com Manutenção", rx: [/^despesas?\s+com\s+manuten[çc][ãa]o$/i] },
    { kind: "item", label: "Despesas com Vendas", rx: [/^despesas?\s+com\s+vendas$/i] },
    { kind: "item", label: "Taxas Accor", rx: [/^taxas?\s+accor/i, /^fees?\s+accor/i] },
    { kind: "item", label: "Taxas de Administração", rx: [/^taxas?\s+de\s+administra[çc][ãa]o$/i, /^taxas?\s+de\s+administra[çc][ãa]o\s+falcon/i, /^fees?\s+falcon/i] },
    ...
    { kind: "total", label: "Resultado Operacional Bruto (GOP)", rx: [/^resultado\s+operacional\s+bruto/i, /^gop$/i] },
    { kind: "total", label: "Lucro / Prejuízo a Distribuir no Período", rx: [/^lucro\s*\/?\s*preju[íi]zo\s+a\s+distribuir/i, /^lucro\s+l[íi]quido\s*\/?\s*preju[íi]zo\s+do\s+exerc/i, /^lucro\s+l[íi]quido$/i, /^resultado\s+l[íi]quido(\s+do\s+exerc[íi]cio)?$/i] },
